...
var ReferenceEntity = /** @class */ (function (_super) {
    __extends(ReferenceEntity, _super);
    ...
    ], ReferenceEntity.prototype, "productId", void 0);
    return ReferenceEntity;
}(defaultClasses_1.TimeStamps));
exports.ReferenceEntity = ReferenceEntity;
exports.ReferenceEntityModel = typegoose_1.getModelForClass(ReferenceEntity, {
    schemaOptions: {
        timestamps: true
    }
});
